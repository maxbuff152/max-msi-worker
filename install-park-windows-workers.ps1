...
Register-ScheduledTask `
  ...
  -Settings $settings `
  -Principal $principal `
  -Description "Park broken Windows Cursor agent-workers (ABI bug). Leaves WSL MSI and trading alone." | Out-Null

Write-Host "Registered scheduled task: $TaskName" -ForegroundColor Green
Write-Host "Canonical agent runtime remains WSL worker MSI." -ForegroundColor Cyan
